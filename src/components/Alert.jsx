...
function Alert(prop) {
  ...
  if (prop.text === "error") {
    bgColor = "#f9c8c8";
  } else if (prop.text === "warning") {
    bgColor = "#f9d9c8";
  } else if (prop.text === "info") {
    bgColor = "#f9ebc8";
  } else if (prop.text === "success") {
    bgColor = "#cef7cd";
  }
  return (
    <>
